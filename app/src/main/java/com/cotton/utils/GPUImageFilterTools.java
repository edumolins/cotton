...
public class GPUImageFilterTools {
    ...
    public static void filtroUno (Context context, final OnGpuImageFilterChosenListener listener){
        createFilterForType(context, FilterType.SEPIA);
    }

    public static void filtroDos (Context context){
        createFilterForType(context, FilterType.SEPIA);
    }
    ...
    private static GPUImageFilter createBlendFilter(Context context, Class<? extends GPUImageTwoInputFilter> filterClass) {
        try {
            ...
            filter.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.music_button));
            return filter;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
